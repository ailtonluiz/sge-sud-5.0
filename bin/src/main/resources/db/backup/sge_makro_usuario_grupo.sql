...
CREATE TABLE `usuario_grupo` (
  ...
  CONSTRAINT `usuario_grupo_ibfk_2` FOREIGN KEY (`codigo_grupo`) REFERENCES `grupo_usuario` (`codigo`)
...
INSERT INTO `usuario_grupo` VALUES (1,1),(3,1),(4,1),(8,1),(1,2),(3,2),(5,2),(6,2),(7,2),(8,2);
...
-- Dump completed on 2022-03-29 23:26:44
