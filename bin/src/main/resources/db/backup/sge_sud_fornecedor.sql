...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_insere_fornecedor
	AFTER INSERT
	ON fornecedor
	FOR EACH ROW
BEGIN
 INSERT INTO sge_makro.fornecedor
( codigo, 
nome, 
email,
telefone,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_update_fornecedor
	AFTER UPDATE
	ON fornecedor
	FOR EACH ROW
BEGIN
 UPDATE sge_makro.fornecedor
SET nome = NEW.nome,
	email = NEW.email,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER trg_delete_fornecedor
	BEFORE DELETE
	ON fornecedor
	FOR EACH ROW
BEGIN
 DELETE FROM sge_makro.fornecedor
