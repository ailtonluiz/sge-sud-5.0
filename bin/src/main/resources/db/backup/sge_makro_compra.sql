...
CREATE TABLE `compra` (
  ...
  `valor_igi` decimal(10,2) DEFAULT NULL,
  ...
  CONSTRAINT `compra_ibfk_1` FOREIGN KEY (`codigo_fornecedor`) REFERENCES `fornecedor` (`codigo`),
  CONSTRAINT `compra_ibfk_2` FOREIGN KEY (`codigo_usuario`) REFERENCES `usuario` (`codigo`)
